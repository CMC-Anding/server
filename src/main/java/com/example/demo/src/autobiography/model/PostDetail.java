...
public class PostDetail {
    ...
    @ApiModelProperty(value = "게시글 내용", example ="초록색 : 성장해나가고 있으며, 꿈꾸고있는 멋진 삶이다.", required = true, dataType = "String")
    ...
    @ApiModelProperty(value = "현재 페이지 번호", example = "2", required = true, dataType = "int")
    private int currentPage;

    @ApiModelProperty(value = "마지막 페이지 번호", example ="3", required = true, dataType = "int")
    private int lastPage;

    public PostDetail(String filterId, String qnaBackgroundColor, String qnaQuestionId, String qnaQuestion, String qnaQuestionMadeFromUser, String contents, String dailyTitle, String dailyImage, String createdAt, int lastPage) {
        this.filterId = filterId;
        this.qnaBackgroundColor = qnaBackgroundColor;
        this.qnaQuestionId = qnaQuestionId;
        this.qnaQuestion = qnaQuestion;
        this.qnaQuestionMadeFromUser = qnaQuestionMadeFromUser;
